	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			// Create Document (WF2)
			{
				...
				options: [
					{ name: 'Article (Artikel)', value: 'Artikel_s' },
					{ name: 'Customer (Kunde)', value: 'Kunden_s' },
					{ name: 'Delivery Note (Lieferschein)', value: 'Lieferschein_s' },
					{ name: 'Delivery Note Position (Lieferschein)', value: 'Lieferscheinpos_s' },
					{ name: 'Inquiry (Anfrage)', value: 'Anfrage_s' },
					{ name: 'Invoice (Rechnung)', value: 'Rechnung_s' },
					{ name: 'Invoice Position (Rechnung)', value: 'Rechnungpos_s' },
					{ name: 'Offer (Angebot)', value: 'Angebot_s' },
					{ name: 'Offer Position (Angebot)', value: 'Angebotpos_s' },
					{ name: 'Order (Auftrag)', value: 'Auftrag_s' },
					{ name: 'Order Position (Auftrag)', value: 'Auftragpos_s' },
					{ name: 'Project (Projekt)', value: 'Projekt' },
					{ name: 'Purchase Invoice (ER)', value: 'ER' },
					{ name: 'Purchase Order (Bestellung)', value: 'Bestellung_s' },
					{ name: 'Purchase Order Position (Bestellung)', value: 'Bestellungpos_s' },
					{ name: 'Supplier (Lieferant)', value: 'Liefer_s' },
				],
			},
			{
